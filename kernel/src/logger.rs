...
use uart::{address::PortAddress, writer::UartWriter};
...
pub fn init(frame_buffer: &'static FramebufferResponse) -> Result<(), log::SetLoggerError> {
    ...
    inner.serial_port = Some(AnyWriter::Com1(unsafe {
        UartWriter::new(PortAddress::new(0x3F8), false)
    }));
